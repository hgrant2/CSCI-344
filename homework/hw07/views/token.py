...
class AccessTokenEndpoint(Resource):
    ...
    def post(self):
        ...
        #accepts username and a password from the body. 
        ...
        # check the database to make sure this particular username and password
        # combo are valid.
        # if they are, return an access and refresh token
        # otherwise, give them some sort of error message
        print(body)
        '''
